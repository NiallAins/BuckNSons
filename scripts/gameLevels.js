	...
	load : {
		...
		partTwo : function() {
			...
			gameObjs.gems = [
				...
				new Gem(100, -5200, "green"),
				new Gem(1200, -5200, "green"),
				...
				new Gem(100, -12500, "red"),
				new Gem(100, -12700, "red"),
				new Gem(1100, -12500, "red"),
				new Gem(1100, -12700, "red"),
				...
				new Gem(600, -14200, "green"),
				new BadGem(600, -14000),
				new Gem(600, -13850, "red"),
				new Gem(600, -13750, "green"),
		...
		partThree : function() {
			...
			gameObjs.gems = [
				...
				new BadGem(3500, -15490),
				new BadGem(4500, -16050),
				new BadGem(5500, -15490),
				new BadGem(6500, -16050),
				new BadGem(7500, -15490),
				new BadGem(8500, -16050),
				new BadGem(9500, -15490),
				new BadGem(15000, -16050),
